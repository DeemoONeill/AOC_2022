...
with open("puzzle.input") as f:
    print("part1 :", sum(scores[intersections(*tup)] for tup in map(split_strings, f.readlines())))


with open("puzzle.input") as f:
    lines = [line.strip() for line in f.readlines()]
    print("part2 :",sum(scores[intersections(*tup)] for tup in zip(lines[::3], lines[1::3], lines[2::3]) ))